...
class user_login(ModelForm):
    class Meta:
        ...
        fields = ['email']
        widgets = {
            'email' : EmailInput(attrs={'autocomplete' : 'off', 'class' : 'form-control form-control-lg', 'id' : 'email-address', 'placeholder' : 'Enter your email address', 'required' : ''}),
        }
